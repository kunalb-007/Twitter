        ...
        <AnimatePresence>
            {randomUsers.slice(0, randomUserNum).map((randomUsr) => (
                ...
                >
                    ...
                    width={40}
                    src={randomUsr.picture.thumbnail}
                    alt=""
                    />
                    <div className="truncate ml-4 leading-5">
                    <h4 className="font-bold hover:underline text-[13px] truncate">
                        {randomUsr.login.username}
                    </h4>
                    <h5 className="text-[12px] text-gray-500 truncate">
                        {randomUsr.name.first + " " + randomUsr.name.last}
                    </h5>
                    </div>
